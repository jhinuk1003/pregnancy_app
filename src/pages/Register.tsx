...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-hotpink-50 to-pink-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 left-20 w-28 h-28 bg-hotpink-200 rounded-full opacity-20 animate-pulse" style={{ animationDelay: '1.5s' }}></div>
      <div className="absolute top-1/3 right-1/3 w-12 h-12 bg-pink-300 rounded-full opacity-15 animate-pulse" style={{ animationDelay: '0.5s' }}></div>
      ...
      >
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-pink-100 dark:border-gray-700">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-2">Join MOMIQ to start your maternal journey</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 dark:text-gray-300">
              ...
              <Link to="/login" className="text-hotpink-600 dark:text-hotpink-400 hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </div>
